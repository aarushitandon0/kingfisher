...
|------|---------|-----------|----------------|------|-------------|---------|
| `data/raw/dem/Copernicus_DSM_COG_10_N18_00_E073_00_DEM.tif` | Copernicus DEM GLO-30 tile N18E073 (30 m) | https://copernicus-dem-30m.s3.amazonaws.com/Copernicus_DSM_COG_10_N18_00_E073_00_DEM/Copernicus_DSM_COG_10_N18_00_E073_00_DEM.tif | 2026-09-24 14:31 | 45.8 MB | `e5e127b1a1b56c04` | Copernicus DEM, free and open (ESA/Airbus) - attribution required |
| `data/raw/dem/Copernicus_DSM_COG_10_N18_00_E074_00_DEM.tif` | Copernicus DEM GLO-30 tile N18E074 (30 m) | https://copernicus-dem-30m.s3.amazonaws.com/Copernicus_DSM_COG_10_N18_00_E074_00_DEM/Copernicus_DSM_COG_10_N18_00_E074_00_DEM.tif | 2026-09-24 14:31 | 39.0 MB | `1a44c053a6ef9e06` | Copernicus DEM, free and open (ESA/Airbus) - attribution required |
...
| `data/raw/landcover/ESA_WorldCover_10m_2021_v200_N18E072_Map.tif` | ESA WorldCover 10 m 2021 v200, tile N18E072 (Pune) | https://esa-worldcover.s3.eu-central-1.amazonaws.com/v200/2021/map/ESA_WorldCover_10m_2021_v200_N18E072_Map.tif | 2026-09-24 14:33 | 125.8 MB | `4d308a33a3051141` | CC-BY-4.0 - ESA WorldCover project / Contains modified Copernicus data |
...
| `data/raw/osm/india-western-zone-latest.osm.pbf` | OSM India western zone extract (Geofabrik, western-zone-latest.osm.pbf) | https://download.geofabrik.de/asia/india/western-zone-latest.osm.pbf | 2026-09-24 14:29 | 220.5 MB | `42b4f2c008223651` | ODbL - OpenStreetMap contributors (attribution required) |
...
| `data/raw/osm/pune_overpass.json` | OSM waterways, roads and exposure features for the Pune bbox (Overpass) | https://overpass-api.de/api/interpreter | 2026-09-24 14:26 | 37.0 MB | `0ff107ae8e29a223` | ODbL - OpenStreetMap contributors (attribution required) |
...
| `data/raw/population/GHS_POP_E2020_GLOBE_R2023A_4326_3ss_V1_0_R8_C26.zip` | GHS-POP 2020, 3 arcsec, tile R8_C26 (western India) | https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL/GHS_POP_GLOBE_R2023A/GHS_POP_E2020_GLOBE_R2023A_4326_3ss/V1-0/tiles/GHS_POP_E2020_GLOBE_R2023A_4326_3ss_V1_0_R8_C26.zip | 2026-09-24 14:35 | 159.3 MB | `ea82d055bca7d4c4` | CC-BY-4.0 - European Commission, Joint Research Centre (GHSL) |
